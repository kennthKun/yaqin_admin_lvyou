<template>
  <div>
    <el-button type="success" @click="dialogFormVisible2 = true">增加新酒店</el-button>
            ...
            <el-form-item label="操作">
              ...
              <el-dialog title="商品编辑" :visible.sync="dialogFormVisible">
                <el-form :model="form">
                  ...
                  <el-form-item label="酒店分类" :label-width="formLabelWidth">
                    <el-select v-model="form.category" placeholder="请选择分类">
                      <el-option label="商务性酒店" value="商务性酒店"></el-option>
                      <el-option label="度假性酒店" value="度假性酒店"></el-option>
                      <el-option label="长住性酒店" value="长住性酒店"></el-option>
                      <el-option label="会议性酒店" value="会议性酒店"></el-option>
                      <el-option label="观光性酒店" value="观光性酒店"></el-option>
                      <el-option label="小型酒店" value="小型酒店"></el-option>
                      <el-option label="中型酒店" value="中型酒店"></el-option>
                      <el-option label="大型酒店" value="大型酒店"></el-option>
                    </el-select>
                  </el-form-item>
    ...
    <el-dialog title="商品编辑" :visible.sync="dialogFormVisible2">
      <el-form :model="form">
        ...
        <el-form-item label="酒店分类" :label-width="formLabelWidth">
          <el-select v-model="form.category" placeholder="请选择分类">
            <el-option label="全部酒店" value="全部酒店"></el-option>
