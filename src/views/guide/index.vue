        ...
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            ...
            <el-form-item label="导游图片">
              <el-upload :on-remove="removeImg" class="upload-demo" action="http://yaqin.ckun.vip:8081/file_upload" :file-list="props.row.longimageList" :on-success="fileListChange" list-type="picture">
              </el-upload>
            </el-form-item>
                ...
                <el-form :model="form">
                  ...
                  <el-form-item label="导游描述" :label-width="formLabelWidth" style="margin-bottom: 30px;">
                    <Tinymce ref="editor" v-model="form.introduce" :height="400" />
								...
								<el-form-item label="导游图片">
			              <el-upload class="upload-demo" :on-remove="removeImg" action="http://yaqin.ckun.vip:8081/file_upload" :file-list="form.longimageList" :on-success="fileListChange" list-type="picture">
