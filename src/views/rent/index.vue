<template>
  <div>
    <el-button type="success" @click="addTicket">增加新司机</el-button>
    <el-table :data="tableData5" style="width: 100%">
      <el-table-column type="expand">
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            ...
            <el-form-item label="司机地址">
              <span>{{ props.row.address }}</span>
            </el-form-item>
            <el-form-item label="司机描述" style="margin-bottom: 30px;">
              <Tinymce ref="editor" v-model="props.row.introduce" :height="400" />
            </el-form-item>
            <el-form-item label="司机图片">
            ...
            <el-form-item label="操作">
              ...
              <!-- 删除结束 -->
              <el-dialog title="司机编辑" :visible.sync="dialogFormVisible">
                <el-form :model="form">
                  <el-form-item label="司机名称" :label-width="formLabelWidth">
                  ...
                  <el-form-item label="司机描述" :label-width="formLabelWidth" style="margin-bottom: 30px;">
      ...
      <el-table-column label="司机地址" prop="address" />
      <el-table-column label="价格" prop="price" />
      <!--<el-table-column label="司机图片" >
    ...
    <el-dialog title="司机添加" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-form-item label="司机名称" :label-width="formLabelWidth">
          <el-input v-model="form.name" auto-complete="off" />
        </el-form-item>
...
//      this.imageUrl = URL.createObjectURL(file.raw);
    ...
    complate: function() {
      ...
      axios.post('http://yaqin.ckun.vip:3002/drivers/add', params)
			  .then(function(response) {
    ...
    handleClose(done) {
      ...
      this.$confirm('确认删除？')
        .then(_ => {
          ...
          axios.get('http://yaqin.ckun.vip:3002/drivers/delete?id=' + done)
            .then(function(response) {
